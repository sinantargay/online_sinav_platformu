...
import currentQuestions from './data/current-questions-2026-06-26-19.json';
...
export default function App() {
  ...
  const allQuestions = useMemo(() => [...currentQuestions, ...questions], []);
  const examQuestions = useMemo(() => allQuestions.slice(0, 50), [allQuestions]);
